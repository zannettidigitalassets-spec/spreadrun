...
export default function HowToAnalyzeGuide() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", color: "#0D1B3E", background: "#fff" }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "How do you analyze a rental property investment?", "acceptedAnswer": {"@type": "Answer", "text": "Start with the purchase price and financing terms to calculate your mortgage payment. Then estimate gross rent, subtract a vacancy allowance, and deduct all operating expenses. What remains is your net cash flow."}}, {"@type": "Question", "name": "What numbers matter most when evaluating a rental property?", "acceptedAnswer": {"@type": "Answer", "text": "The four most important metrics are: monthly cash flow, cash-on-cash return, cap rate, and DSCR."}}, {"@type": "Question", "name": "What is a good cash-on-cash return for a rental property?", "acceptedAnswer": {"@type": "Answer", "text": "Most investors target 8-12% or higher. Below 6% is generally considered thin unless you are banking heavily on appreciation."}}, {"@type": "Question", "name": "How do I know if a rental property is a good deal?", "acceptedAnswer": {"@type": "Answer", "text": "A good rental deal typically has positive monthly cash flow, a DSCR above 1.25, a cap rate at or above local market averages, and a cash-on-cash return above 8%."}}, {"@type": "Question", "name": "What vacancy rate should I use when analyzing a rental property?", "acceptedAnswer": {"@type": "Answer", "text": "Most investors use a 5-10% vacancy rate as a conservative estimate. In strong rental markets, 5% is reasonable."}}]}' }} />
      <style>{`
        @media (max-width: 760px) {
          .sr-howtoanalyzeguide-nav-links-desktop {
            display: none !important;
          }
          .sr-howtoanalyzeguide-nav-hamburger {
      ...
      <nav style={{
        ...
        <div className="sr-howtoanalyzeguide-nav-links-desktop" style={{ display: "flex", alignItems: "center", gap: 20 }}>
        ...
        <button
          className="sr-howtoanalyzeguide-nav-hamburger"

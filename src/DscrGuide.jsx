...
export default function DscrGuide() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", color: "#0D1B3E", background: "#fff" }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is DSCR in real estate?", "acceptedAnswer": {"@type": "Answer", "text": "DSCR stands for Debt Service Coverage Ratio. It measures how much income a property produces relative to its debt obligations. A DSCR above 1.0 means the rent covers the mortgage payment; above 1.25 is what most lenders require for investor financing."}}, {"@type": "Question", "name": "What DSCR do I need to qualify for a loan?", "acceptedAnswer": {"@type": "Answer", "text": "Most lenders require a minimum DSCR of 1.25, meaning the property\'s gross rent must be at least 125% of the monthly PITI payment (principal, interest, taxes, and insurance). Some lenders will approve at 1.0, but with higher rates and larger down payments."}}, {"@type": "Question", "name": "How do I calculate DSCR?", "acceptedAnswer": {"@type": "Answer", "text": "Divide the property\'s monthly gross rent by the total monthly PITI payment. For example, if rent is $2,000 and PITI is $1,600, the DSCR is 1.25 \\u2014 which meets most lenders\' minimum requirement."}}, {"@type": "Question", "name": "What happens if my DSCR is below 1.25?", "acceptedAnswer": {"@type": "Answer", "text": "If your DSCR is below 1.25, you can improve it by increasing the rent, reducing the loan amount with a larger down payment, finding a lower interest rate, or negotiating a lower purchase price."}}, {"@type": "Question", "name": "Do DSCR loans require income verification?", "acceptedAnswer": {"@type": "Answer", "text": "No. DSCR loans qualify based on the property\'s rental income, not your personal W-2 income or tax returns. This makes them popular with self-employed investors and those with multiple properties."}}]}' }} />
      <style>{`

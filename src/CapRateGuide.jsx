...
export default function CapRateGuide() {
  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", color: "#0D1B3E", background: "#fff" }}>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: '{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "What is cap rate in real estate?", "acceptedAnswer": {"@type": "Answer", "text": "Cap rate (capitalization rate) is the ratio of a property\'s annual net operating income (NOI) to its purchase price or market value. A higher cap rate generally means more income relative to price."}}, {"@type": "Question", "name": "What is a good cap rate for a rental property?", "acceptedAnswer": {"@type": "Answer", "text": "A good cap rate depends on your market. In expensive coastal markets, 4-5% may be solid. In Midwest or Sun Belt markets, investors typically target 6-10% or higher."}}, {"@type": "Question", "name": "How do I calculate cap rate?", "acceptedAnswer": {"@type": "Answer", "text": "Divide the property\'s annual net operating income (NOI) by its purchase price. NOI is gross rent minus all operating expenses excluding the mortgage."}}, {"@type": "Question", "name": "What is the difference between cap rate and cash-on-cash return?", "acceptedAnswer": {"@type": "Answer", "text": "Cap rate ignores financing and measures the property\'s income as a percentage of its value. Cash-on-cash return accounts for your mortgage and measures your actual return on the cash invested."}}, {"@type": "Question", "name": "Can cap rate change over time?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Cap rate changes if the property\'s income changes or if the market value changes. As property values rise, cap rates compress."}}]}' }} />
      <style>{`
